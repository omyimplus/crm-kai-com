-- Opportunity — lead-sourced fields read-only · probability from stage only
...
BEGIN
  ...
  INSERT INTO public.opportunities (
    ...
    public.lead_address_snapshot(p_lead_id),
    auth.uid()
  )
...
BEGIN
  ...
  SELECT l.lead_value INTO v_lead_value
  FROM public.leads l
  ...
  SET
    ...
    estimated_value = coalesce(v_lead_value, estimated_value),
    close_date = CASE
