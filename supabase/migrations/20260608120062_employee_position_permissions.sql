-- Add master.employeePosition permission key + sales template view access
...
RETURNS text[] AS $$
  SELECT ARRAY[
    ...
    'master.category', 'master.leadSource', 'master.partner', 'master.employeePosition',
    'master.unit', 'master.employee', 'master.salesTeam', 'master.roles',
    'master.moduleStatuses', 'master.jobCode'
  ]::text[];
