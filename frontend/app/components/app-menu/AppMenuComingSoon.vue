...
const item = computed(() => appMenuItems.find(i => i.key === props.menuKey)!)
const title = computed(() => t(`appMenu.${props.menuKey}.title`))
const description = computed(() => t(`appMenu.${props.menuKey}.description`))
const features = computed(() => {
  const raw = tm(`appMenu.${props.menuKey}.features`) as string[] | string
