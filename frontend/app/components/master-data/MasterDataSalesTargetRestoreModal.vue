...
<template>
  <AppDialog
    v-model:open="open"
    :title="t('masterData.salesTarget.restoreTitle')"
    size="sm"
  >
    <p class="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
      {{ t('masterData.salesTarget.restoreConfirm', { name: label }) }}
    </p>
